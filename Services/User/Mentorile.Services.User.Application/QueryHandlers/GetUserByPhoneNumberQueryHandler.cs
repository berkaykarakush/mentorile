...
public class GetUserByPhoneNumberQueryHandler : IRequestHandler<GetUserByPhoneNumberQuery, Result<UserDTO>>
{
    ...
    public GetUserByPhoneNumberQueryHandler(IUserRepository userRepository, IMapper mapper)
    {
    ...
    {
        var userResult = await _userRepository.GetByPhoneNumberAsync(request.PhoneNumber);
